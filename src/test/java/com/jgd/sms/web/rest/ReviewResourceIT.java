...
import com.jgd.sms.domain.Review;
import com.jgd.sms.repository.ReviewRepository;
...
public class ReviewResourceIT {
    ...
    public void createReview() throws Exception {
        ...
        assertThat(testReview.getNumber()).isEqualTo(DEFAULT_NUMBER);
    ...
    public void updateReview() throws Exception {
        ...
        Review testReview = reviewList.get(reviewList.size() - 1);
        assertThat(testReview.getNumber()).isEqualTo(UPDATED_NUMBER);
