...
describe('Student e2e test', () => {
  ...
  it('should create and save Students', async () => {
    async function createStudent() {
      ...
      await studentUpdatePage.setDescriptionInput('description');
      expect(await studentUpdatePage.getDescriptionInput()).to.match(/description/);
  ...
  it('should delete last Student', async () => {
    ...
    expect(await studentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/studentmanagementsystemApp.student.delete.question/);
