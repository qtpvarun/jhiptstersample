...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jgd.sms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jgd.sms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
