    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="studentmanagementsystemApp.review.home.createOrEditLabel">Create or edit a Review</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : reviewEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="numberLabel" for="review-number">
                    Number
                  </Label>
                  <AvField id="review-number" type="text" name="number" />
                </AvGroup>
                <AvGroup>
